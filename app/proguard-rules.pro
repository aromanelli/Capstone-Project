# https://medium.com/code-procedure-and-rants/android-my-standard-proguard-ffeceaf65521
...
-keepclassmembers,includedescriptorclasses class * implements android.arch.lifecycle.LifecycleObserver {
    <init>(...);
}
# ViewModel's empty constructor is considered to be unused by proguard
-keepclassmembers,includedescriptorclasses class * extends android.arch.lifecycle.ViewModel {
    <init>(...);
}
# keep Lifecycle State and Event enums values
-keepclassmembers,includedescriptorclasses class android.arch.lifecycle.Lifecycle$State { *; }
-keepclassmembers,includedescriptorclasses class android.arch.lifecycle.Lifecycle$Event { *; }
...
# Added by me ...
-keep,includedescriptorclasses class com.crashlytics.android.core.** { *; }
...
######################################################################################
-keep class info.romanelli.udacity.capstone.reddit.data.net.subreddits.model.** { *; }
-keep class info.romanelli.udacity.capstone.reddit.data.net.newposts.model.** { *; }
######################################################################################


####################################################################
####################################################################
# BELOW ADDED BY ME TO GET RID OF FALSE-POSITIVE ERRORS/WARNINGS ...
####################################################################
